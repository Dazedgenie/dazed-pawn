...
function StartNewRun()
    if Config.PawnSold >= 1 then
        ESX.TriggerServerCallback('disc-base:takePlayerMoney', function(took)
            ...
            Config.PawnSold = Config.PawnSold - 1
            print(Config.PawnSold)
            currentPawnTask = {
    ...
    elseif Config.PawnSold <= 0 then 
        exports['mythic_notify']:SendAlert('error', 'All Pawn lists have been sold already today. Check back later.')
    end
